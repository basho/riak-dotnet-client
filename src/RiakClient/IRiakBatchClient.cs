...
namespace RiakClient
{
    ...
    public interface IRiakBatchClient
    {
        ...
        /// </remarks>
        IEnumerable<RiakResult<RiakObject>> Get(IEnumerable<RiakObjectId> objectIds, RiakGetOptions options = null);
        ...
        /// </param>  
        /// <returns>
        /// An <see cref="System.Collections.Generic.IEnumerable{T}"/> of <see cref="RiakResult"/>, one for each individual delete operation.
